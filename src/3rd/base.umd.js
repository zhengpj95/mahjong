(function (global, factory) {
  ...
  class ModalLayer extends BaseLayer {
      ...
      addChild(node) {
          ...
          if (node instanceof Laya.Scene) {
              ...
              if (mdr === null || mdr === undefined ? undefined : mdr.isEaseClose) {
  ...
  class BaseMediator extends BaseEmitter {
      constructor(parent, url, isEaseClose) {
          super();
          this.ui = undefined;
          this.isOpened = false;
          this.isEaseClose = false;
          this.uiUrl = url;
          ...
          this.isEaseClose = isEaseClose !== null && isEaseClose !== undefined ? isEaseClose : false;
      }
      setModule(module) {
          this._module = module;
